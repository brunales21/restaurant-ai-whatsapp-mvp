package com.restaurant.mcpclient.client;
...
public class TwilioWhatsappClient {
    ...
    public String normalizeWhatsappAddress(String value) {
    ...
    public String toDigitsOnly(String value) {
        return normalizeWhatsappAddress(value)
